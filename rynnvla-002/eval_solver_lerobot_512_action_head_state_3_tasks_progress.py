...
from model import ChameleonXLLMXConfig, ChameleonXLLMXForConditionalGeneration_ck_action_head_progress
...
class Solver(PretrainSolverBase):
    ...
    def _model_func(
        self,
        init_from: str,
    ) -> (ChameleonXLLMXForConditionalGeneration_ck_action_head_progress, None):
        ...
        model = ChameleonXLLMXForConditionalGeneration_ck_action_head_progress.from_pretrained(
            init_from,
