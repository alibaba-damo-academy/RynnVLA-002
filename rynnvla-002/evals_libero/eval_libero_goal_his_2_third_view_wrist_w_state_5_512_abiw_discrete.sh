...
data_config_train=../configs_libero/libero_goal/his_2_third_view_wrist_w_state_5_512_abiw.yaml
data_config_val_ind=../configs_libero/libero_goal/his_2_third_view_wrist_w_state_5_512_abiw.yaml
data_config_val_ood=../configs_libero/libero_goal/his_2_third_view_wrist_w_state_5_512_abiw.yaml
time_horizon=5
epoch_num=16
...
torchrun --nnodes=1 --nproc_per_node=1 --master_port=$((29531)) ../eval_solver_libero_discrete.py \
    --device 2 \
