...
data_config_train=../configs_libero/libero_spatial/his_2_third_view_wrist_w_state_10_512_abiw.yaml
data_config_val_ind=../configs_libero/libero_spatial/his_2_third_view_wrist_w_state_10_512_abiw.yaml
data_config_val_ood=../configs_libero/libero_spatial/his_2_third_view_wrist_w_state_10_512_abiw.yaml
time_horizon=10
epoch_num=18
task_suite=libero_spatial
exp_name=his_2_third_view_wrist_w_state_10_512_abiw
...
torchrun --nnodes=1 --nproc_per_node=1 --master_port=$((29526)) ../eval_solver_libero_continous_w_state.py \
    --device 1 \
