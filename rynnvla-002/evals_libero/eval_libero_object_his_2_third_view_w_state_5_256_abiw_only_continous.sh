...
data_config_train=../configs_libero/libero_object/his_2_third_view_wrist_w_state_5_256_abiw.yaml
data_config_val_ind=../configs_libero/libero_object/his_2_third_view_wrist_w_state_5_256_abiw.yaml
data_config_val_ood=../configs_libero/libero_object/his_2_third_view_wrist_w_state_5_256_abiw.yaml
time_horizon=5
epoch_num=39
task_suite=libero_object
exp_name=libero_ts_object_his2imgonly_lr5e6_bs8_ck_5_1a2i_w004_part_512_ctw_5_conti_only
his_setting=his_2_third_view_wrist_w_state
eval_setting=continous
# base_exp_name=libero_object_his_2_third_view_wrist_w_state_5_256_abiw
...
torchrun --nnodes=1 --nproc_per_node=1 --master_port=$((29414)) ../eval_solver_libero_continous_w_state.py \
    --device 0 \
