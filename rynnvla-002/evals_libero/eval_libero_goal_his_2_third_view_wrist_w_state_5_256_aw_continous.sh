...
data_config_train=../configs_libero/libero_goal/his_2_third_view_wrist_w_state_5_256_aw.yaml
data_config_val_ind=../configs_libero/libero_goal/his_2_third_view_wrist_w_state_5_256_aw.yaml
data_config_val_ood=../configs_libero/libero_goal/his_2_third_view_wrist_w_state_5_256_aw.yaml
time_horizon=5
epoch_num=29
task_suite=libero_goal
exp_name=his_2_third_view_wrist_w_state_5_256_aw
his_setting=his_2_third_view_wrist_w_state
eval_setting=continous
# base_exp_name=libero_goal_his_2_third_view_wrist_w_state_5_256_aw
...
torchrun --nnodes=1 --nproc_per_node=1 --master_port=$((29508)) ../eval_solver_libero_continous.py \
    --device 5 \
