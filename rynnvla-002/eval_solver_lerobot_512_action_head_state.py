...
class Solver(PretrainSolverBase):
    ...
    def load_data_by_index_state(self, idx: int, base_path: str = "/public/hz_oss/cenjun/WorldVLA/worldvla/ckpts/data_1/episode_000025_abs_state"):
        """
        根据索引(idx)加载对应的图像和动作数据。
