...
from lerobot_util.Chameleon_utils import get_action_Chameleon_dis_awm_ck, get_action_Chameleon_dis_awm_ck_wrist
...
class Solver(PretrainSolverBase):
    ...
    def load_data_by_index(self, idx: int, base_path: str = "/public/hz_oss/cenjun/WorldVLA/worldvla/ckpts/data_1/episode_000040"):
        """
    ...
    def val_libero_wrist(self,):
        ...
        for idx, img_c in enumerate(all_imgs):
            ...
            import time
            start = time.time()
            dis_action = get_action_Chameleon_dis_awm_ck_wrist(
                self.model,
                cur_img,
                cur_img_wrist,
                self.args.task_suite_name,
    ...
    def get_action_wrist(self, input_image, img1, state, prompt):
