...
def main():
    base_path = "/mnt/PLNAS/cenjun/all_data/extracted"
    episode_dirs = find_episode_directories(base_path)
    
    print(f"找到 {len(episode_dirs)} 个符合条件的目录。")

    episode_dirs = ['/mnt/PLNAS/cenjun/all_data/extracted/Place_the_block_inside_the_circle./yumingj/data/LeRobot_data_hdf5/hdf5/standard_desktop_data/data_0616/laptop_03/so100_Pick-up-all-the-blocks-one-by-one-with-tweezers-and-put-them-in-the-roll-2']
    
    all_files = find_all_action_npy_files_fast(episode_dirs)
